...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      await axios.post('https://microfinance-backend-production.up.railway.app/api/auth/register', { 
        name, 
        email, 
        password 
      });
        ...
        <div className="p-8">
              ...
              {isLoading ? (
                ...
                <span className="flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <path fillRule="evenodd" d="M17 5a1 1 0 01.707 1.707l-7 7a1 1 0 01-1.414 0l-7-7A1 1 0 015 5h12z" clipRule="evenodd" />
                  </svg>
                  Register
                </span>
              )}
          ...
          <div className="mt-6 text-center">
            <p className="text-white/70 text-sm">
              ...
              <a href="/login" className="text-white hover:text-purple-200 font-medium transition-colors">
                Sign in
              </a>
            </p>
          </div>
